using RefreshAccessToken.Services;
using Microsoft.AspNetCore.Mvc;
using RefreshAccessToken.Requests;

namespace RefreshAccessToken.Controllers;
...
public class TokenController(JwtTokenProvider tokenProvider) : ControllerBase
{
    ...
    {
        // get refresh token record form database
        ...
        // generate new jwt access token with new refresh token
