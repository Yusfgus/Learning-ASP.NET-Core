...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("https://localhost:7070") // Access-Control-Allow-Origin: https://localhost:7070
                .AllowAnyMethod(); // Access-Control-Allow-Methods: GET, POST, PUT, DELETE, ...
    });
});
