...
using QueryStringMinimal.Data;
using QueryStringMinimal.Endpoints.V1;
using QueryStringMinimal.Endpoints.V2;
...
builder.Services.AddApiVersioning(options =>
{
    ...
    options.ApiVersionReader = new QueryStringApiVersionReader("api-version"); // /api/products?api-version=1.0
});
