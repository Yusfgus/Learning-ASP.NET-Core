...
using QueryStringMinimal.Responses.V1;

namespace QueryStringMinimal.Endpoints.V1;
...
public static class ProductEndpoints
{
    ...
    private static void AlertClient(HttpResponse response)
    {
