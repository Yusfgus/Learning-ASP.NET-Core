...
using RepositoryPattern.Requests;
using RepositoryPattern.Responses;
using Microsoft.AspNetCore.Http.HttpResults;
using RepositoryPattern.Interfaces;

namespace RepositoryPattern.Endpoints;
...
public static class ProductEndpoints
{
    ...
    private static async Task<IResult> GetPaged(IProductRepository repository, int page = 1, int pageSize = 10)
    {
