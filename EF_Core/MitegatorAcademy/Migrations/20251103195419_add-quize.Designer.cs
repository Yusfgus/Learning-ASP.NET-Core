...
namespace MitegatorAcademy.Migrations
{
    ...
    [Migration("20251103195419_add-quize")]
    partial class addquize
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EF_Core.MitegatorAcademy.Entities.Course", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EF_Core.MitegatorAcademy.Entities.Office", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EF_Core.MitegatorAcademy.Entities.Quiz", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EF_Core.MitegatorAcademy.Entities.Section", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EF_Core.MitegatorAcademy.Entities.MultipleChoiceQuiz", b =>
                {
                    b.HasBaseType("EF_Core.MitegatorAcademy.Entities.Quiz");
            ...
            modelBuilder.Entity("EF_Core.MitegatorAcademy.Entities.TrueAndFalseQuiz", b =>
                {
                    b.HasBaseType("EF_Core.MitegatorAcademy.Entities.Quiz");
            ...
            modelBuilder.Entity("EF_Core.MitegatorAcademy.Entities.Instructor", b =>
                {
                    b.HasOne("EF_Core.MitegatorAcademy.Entities.Office", "Office")
                        .WithOne("Instructor")
                        .HasForeignKey("EF_Core.MitegatorAcademy.Entities.Instructor", "OfficeId");
            ...
            modelBuilder.Entity("EF_Core.MitegatorAcademy.Entities.Quiz", b =>
                {
                    b.HasOne("EF_Core.MitegatorAcademy.Entities.Course", "Course")
                        .WithMany()
            ...
            modelBuilder.Entity("EF_Core.MitegatorAcademy.Entities.Section", b =>
                {
                    ...
                    b.HasOne("EF_Core.MitegatorAcademy.Entities.Instructor", "Instructor")
                        .WithMany("Sections")
                        .HasForeignKey("InstructorId");

                    b.HasOne("EF_Core.MitegatorAcademy.Entities.Schedule", "Schedule")
                        .WithMany("Sections")
                        .HasForeignKey("ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("EF_Core.MitegatorAcademy.Entities.TimeSlot", "TimeSlot", b1 =>
                        {
