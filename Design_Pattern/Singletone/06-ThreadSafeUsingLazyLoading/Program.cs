...
namespace Design_Pattern.Singleton.ThreadSafeUsingLazyLoading;
...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Utils.printTitle("Singleton ( Thread Safe Using Lazy Loading )", width: 70, color: ConsoleColor.Blue);
