...
namespace Design_Pattern.Singleton.ThreadSafeUsingEagerLoading;
...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Utils.printTitle("Singleton ( Thread Safe Using Eager Loading )", width: 70, color: ConsoleColor.Blue);
